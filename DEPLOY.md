...
- index.html        (must contain `data-build="9.3"` on the `<html>` tag)
- styles.css
- app.js
- scan-worker.js
- sw.js
...
4. Verify what the CDN is actually serving (private/incognito window):
   ...
   View source — the first line must be:  `<html lang="en" data-build="9.3">`
...
4. More → About should show **version 9.3**.
